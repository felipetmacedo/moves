  ...
  return (
    <ContactSectionContainer id={id}>
      ...
      <TextContainer>
        <Title>CONTATO</Title>
        <ParagraphContainer>
          Se interessou pela nossa solução ou quer fazer parte dela? Tem mais
          alguma dúvida? Não exite em falar conosco!
        </ParagraphContainer>
        <form
          onSubmit={handleSubmit}
          style={
            isMediumScreen
              ? { ...formStyles, ...formStylesMediumScreen }
              : formStyles
          }
        >
          <Input
